...
| <a name="input_eks_cluster_oidc_issuer_urls"></a> [eks\_cluster\_oidc\_issuer\_urls](#input\_eks\_cluster\_oidc\_issuer\_urls) | OIDC issuer URLs for the EKS cluster (initial "https://" may be omitted) | `set(string)` | n/a | yes |
