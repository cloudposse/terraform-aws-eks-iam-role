...
func TestExamplesComplete(t *testing.T) {
  ...
  serviceAccountRoleNameStaus := terraform.Output(t, terraformOptions, "service_account_role_name")
  // Verify we're getting back the outputs we expect
  // This output depends on namespace,
  assert.Equal(t, "eg-ue2-test-eks-"+randId+"-autoscaler@kube-system", serviceAccountRoleNameStaus)
